...
typedef enum _MessageT__Opcode {
  ...
  MESSAGE_T__OPCODE__OP_SIZE_R = 11,
  MESSAGE_T__OPCODE__OP_DEL = 20,
  MESSAGE_T__OPCODE__OP_DEL_R = 21,
  MESSAGE_T__OPCODE__OP_GET = 30,
  MESSAGE_T__OPCODE__OP_GET_R = 31,
  MESSAGE_T__OPCODE__OP_PUT = 40,
  MESSAGE_T__OPCODE__OP_PUT_R = 41,
  MESSAGE_T__OPCODE__OP_GETKEYS = 50,
  MESSAGE_T__OPCODE__OP_GETKEYS_R = 51,
  MESSAGE_T__OPCODE__OP_VERIFY = 60,
  MESSAGE_T__OPCODE__OP_VERIFY_R = 61,
...
#define MESSAGE_T__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&message_t__descriptor) \
    , MESSAGE_T__OPCODE__OP_BAD, MESSAGE_T__C_TYPE__CT_BAD, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0 }
